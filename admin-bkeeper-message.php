            ...
            <div class="container-fluid">
                ...
                if ($_SERVER["REQUEST_METHOD"] == "POST") {
                    $sql = "INSERT INTO messages (`sender_id`, `receiver_id`, `message`, `date`)
                                VALUES ('" . $_SESSION['user_id'] . "',' " . $bkeeper_id . "', '" . $_POST['message']
                        . "', '" . date('Y-m-d H:i:s') . "')";
                ...
                <div class="card p-5 shadow" style="overflow-y: auto; height:350px;">
                    <?php
                    $sql = "SELECT * FROM messages join users on messages.sender_id = users.id WHERE sender_id = " . $bkeeper_id . " OR receiver_id = " . $bkeeper_id . " OR sender_id = " . $_SESSION['user_id'] . " OR receiver_id = " . $_SESSION['user_id'] . " ORDER BY date ASC";
                ...
                <form action="" method="POST" class="mt-3 shadow mb-5 p-2">
                    <div class="form-group mb-2">
                        <input type="hidden" name="bkeeper_id" value="<?php echo $bkeeper_id ?>" />
