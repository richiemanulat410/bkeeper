                        ...
                        if (mysqli_num_rows($result) > 0) {
                            while ($row = mysqli_fetch_assoc($result)) {
                                ...
                                echo '</small>
                                                ...
                                                <a href="bkeeper-decrypt-file.php?id=' . $_SESSION["id"] . '" class="btn btn-outline-primary">Download Decrypted File</a>
                                                <a href="bkeeper-decrypt-file-email.php?id=' . $_SESSION["id"] . '" class="btn btn-primary">Send Decrypted File on Email</a>
                                            </div>
                                        </div>
                                    </div>';
                            }
