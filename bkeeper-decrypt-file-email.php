            ...
            <div class="container-fluid">
                        ...
                        if (mysqli_num_rows($result) > 0) {
                            while ($row = mysqli_fetch_assoc($result)) {
                                ...
                                // echo 'Message has been sent';
                                    echo '<script>window.location.href="bkeeper-documents-content.php?id='.$_SESSION['id'].'"</script>';
                                } catch (Exception $e) {
                                    echo '<script>alert("Cannot Send to You Email")</script>';
                ...
                ?>
                    ...
                    <form method="post" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>">
                        ...
                        <a href="bkeeper-documents-content.php?id=<?php echo $_GET['id']; ?>" class="btn btn-danger">No</a>
                    </form>
                <?php endif; ?>
            </div>
        </div>
