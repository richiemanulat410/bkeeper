            ...
            <div class="container-fluid">
                ...
                if (isset($_POST['approve_button'])) {
                    ...
                    if ($conn->query($sql) === TRUE) {
                        echo '<h1 class="mt-4 text-success">Successfully Approved User!</h1>';
                ...
                <form method="post" action="<?php echo $_SERVER['PHP_SELF']; ?>">
                    ...
                    if (isset($_POST['approve_button'])) {
                        ...
                        echo ' <button class="btn btn-primary" type="submit" name="approve_button">Approve Application</button>
