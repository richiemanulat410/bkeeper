        ...
        <div id="page-content-wrapper">
            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    ...
                    <?php
                    $sql = "SELECT * FROM users WHERE role = 'bkeeper' AND id IN (SELECT bkeeper_id FROM applicants WHERE client_id = " . $_SESSION['user_id'] . ") ";
                                        ...
                                        <div class="col-md-8">
                                            <div class="card-body">
                                                <h4 class="card-title text-primary">' . $row['name'] . '
                                                    <a href="admin-add-bkeeper.php?id=' . $row['id'] . '" class="btn btn-success btn-sm"><i class="fa fa-check"></i> Approve</a>
                                                </h4>
