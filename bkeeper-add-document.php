        ...
        <div id="page-content-wrapper">
            ...
            <div class="container-fluid">
                ...
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb">
                        <li class="breadcrumb-item"><a href="bkeeper-documents.php?id=<?php echo $_GET['id'] ?>">Documents</a></li>
                ...
                if ($_SERVER["REQUEST_METHOD"] == "POST") {
                    ...
                    if (mysqli_query($conn, $sql)) {
                        ...
                        window.location.href="bkeeper-documents.php?id=' . $idtest . '" 
                        </script>';
                    } else {
                ...
                <div class="col-md-4">
                    <form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" method="post" role="form" class="php-email-form" enctype="multipart/form-data">
                        <div class="form-group">
                            <input type="hidden" class="form-control" name="idtest" value="<?php echo $_GET['id'] ?>" id="idtest" required>
                        </div>
                        <div class="form-group">
