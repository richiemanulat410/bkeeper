        ...
        <div id="page-content-wrapper">
            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    ...
                    <div class="col-md-4">
                        <a href="admin-add-document.php" class="btn btn-outline-success" id="button-addon2">Add Document <i class="fa fa-file"></i></a>
                ...
                <div class="row">
                    ...
                    (SELECT role from users WHERE users.id = bkeeps.user_id) as `role`
                     FROM bkeeps WHERE user_id = " . $_SESSION['user_id']. " OR user_id IN (SELECT bkeeper_id FROM bkeepers WHERE client_id = " . $_SESSION['user_id'] . ")";
                                    ...
                                    <div class="card mb-3 shadow bg-body rounded">
                                        <div class="row g-0">
                                            <div class="card-body">
                                                ...
                                                href="admin-documents-content.php?id='.$row['id'].'">'.$row['title'].'';
